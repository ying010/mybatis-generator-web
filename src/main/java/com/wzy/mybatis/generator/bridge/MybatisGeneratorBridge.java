package com.wzy.mybatis.generator.bridge;

import com.wzy.mybatis.generator.model.DatabaseConfig;
import com.wzy.mybatis.generator.model.DbType;
import com.wzy.mybatis.generator.model.GeneratorConfig;
import com.wzy.mybatis.generator.plugins.DbRemarksCommentGenerator;
import com.wzy.mybatis.generator.util.ConfigHelper;
import com.wzy.mybatis.generator.util.DbUtil;
...
public class MybatisGeneratorBridge {
    ...
    public void generate() throws Exception {
        ...
        if (generatorConfig.isJsr310Support()) {
            ...
            javaTypeResolverConfiguration.setConfigurationType("JavaTypeResolverJsr310Impl");
        ...
        if (generatorConfig.isNeedForUpdate()) {
            if (DbType.MySQL.name().equals(dbType)
                    || DbType.PostgreSQL.name().equals(dbType)) {
                PluginConfiguration pluginConfiguration = new PluginConfiguration();
                pluginConfiguration.addProperty("type", "MySQLForUpdatePlugin");
                pluginConfiguration.setConfigurationType("MySQLForUpdatePlugin");
                context.addPluginConfiguration(pluginConfiguration);
            }
        }
        //repository 插件
